...
public class CusipLeveMrkValueFlatMap extends RichCoFlatMapFunction<Price, PositionBySymbol, PositionBySymbol> {
    ...
    @Override
    public void flatMap1(Price price, Collector<PositionBySymbol> out) throws Exception {
    ...
    @Override
    public void flatMap2(PositionBySymbol position, Collector<PositionBySymbol> out) throws Exception {
